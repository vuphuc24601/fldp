...
def args_parser():
    ...
    parser.add_argument("--clipping_threshold", type=int, default=1, help="clipping threshold")
    parser.add_argument("--num_uplink_exposures", type=int, default=4, help="number of uplink channels exposures: L")
    ...
    args.out_file_baseline = f"results/baseline/N{args.num_users}_K{args.num_chosen_clients}_T{args.num_rounds}.pkl"
    args.out_file_dp = f"results/dp/N{args.num_users}_" \
